    ...
    >
      <template v-slot:[`item.actions`]="{ item }">
        <v-icon small class="mr-2" @click="editCustomer(item.id)"
          >mdi-pencil</v-icon
        >
        <v-icon small class="mr-2" @click="deleteCustomer(item.id)"
          >mdi-delete</v-icon
        >
        <v-icon small class="mr-2" @click="infoCustomer(item.id)">
    ...
    <template>
      ...
      >
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="warning" text @click="editCustomer(customer_info.id)">
              Edit
            </v-btn>
